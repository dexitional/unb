...
function PageTitle({ title,color }: any) {
  return (
    <div className={ color ? `z-30 sticky top-28 p-6 sm:p-10 bg-[${color}] rounded-xl sm:rounded-3xl overflow-hidden`:`z-30 sticky top-28 p-6 sm:p-10 rounded-xl sm:rounded-3xl bg-[#ffcba6] overflow-hidden`}>
