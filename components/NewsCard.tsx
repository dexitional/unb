  ...
  return (
    ...
    <div className="w-full sm:max-w-[480px] rounded-3xl shadow-xl overflow-hidden">
      ...
      <div className="px-8 py-6 bg-white flex flex-col space-y-3">
        <h1 className="text-md sm:text-[1.3rem] font-bold font-epilogue text-[#081b4b] leading-tight md:leading-7">{title}</h1>
        <div>
            <span className="text-blue-600 text-sm md:text-default">{author}</span>
